...
function SidebarGroupLabel({
  ...
  return (
    (<Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 ring-sidebar-ring flex h-6 shrink-0 items-center rounded-md px-1.5 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-3 [&>svg]:shrink-0",
